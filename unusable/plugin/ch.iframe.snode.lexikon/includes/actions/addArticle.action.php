...
$GLOBALS['plugin']->setSessionValue('previousAdminModule', $GLOBALS['plugin']->getSessionValue('adminModule'));
    XT::query("INSERT INTO " . $GLOBALS['plugin']->getTable('articles') . " (id, unit, quantity, art_nr, active,cdate) VALUES (NULL, NULL, NULL, NULL, 0," . TIME . ")",__FILE__,__LINE__);
    ...
    foreach ($GLOBALS['cfg']->getLangs() as $key => $lang){
        XT::query("INSERT INTO
                      ...
                      (id, lang, title, lead, package, active)
                  VALUES
