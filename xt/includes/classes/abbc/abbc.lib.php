...
.abbc, .abbc .p, .abbc li
{
	font: $abbc_cfg[basefont];
}
.abbc .p
{
	margin: $abbc_cfg[par_margin];
}
...
EOF;
	...
	if ($abbc_cfg['custom_a']) $css .= <<<EOF
.abbc a
{
	color: $abbc_cfg[a_color];
	text-decoration: $abbc_cfg[a_decor];
}
.abbc a:hover
{
	color: $abbc_cfg[a_color_hover];
	text-decoration: $abbc_cfg[a_decor_hover];
}
EOF;
