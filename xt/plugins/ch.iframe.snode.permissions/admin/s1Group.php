...
// 1-4 perms
$perms[1]['perm'] = 'Package Permissions';
...
// Save Button
XT::addImageButton('[S]ave','s1SaveGroupPermission','default','disk_blue.png','0','slave1','s');
XT::addImageButton('Save [a]ll languages','s1SaveGroupPermissionAllLang','default','disk_blue.png','0','slave1','a');
XT::addImageButton('[U]nset','s1UnsetGroupPermission','default','delete.png','0','slave1','u');
