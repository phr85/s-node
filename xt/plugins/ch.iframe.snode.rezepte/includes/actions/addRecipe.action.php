...
$GLOBALS['plugin']->setSessionValue('previousAdminModule', XT::getSessionValue('adminModule'));
    XT::query("INSERT INTO " . XT::getTable('rezepte') . " (id, c_date, c_user, active_by_user) VALUES (NULL, " . TIME . ", " . XT::getUserID() . ",1)",__FILE__,__LINE__);
    ...
    XT::log("New recipe ",__FILE__,__LINE__,XT_INFO);
?>