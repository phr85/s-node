...
XT::query("UPDATE " . $GLOBALS['plugin']->getTable('articles_tree_details') . " SET active = 1 WHERE lang = '" . $GLOBALS['plugin']->getActiveLang() . "' AND node_id = " . $GLOBALS['plugin']->getValue('id'),__FILE__,__LINE__);
