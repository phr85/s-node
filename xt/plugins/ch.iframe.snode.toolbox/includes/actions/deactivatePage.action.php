<?php
XT::call("saveInfo");
XT::query("UPDATE " . $GLOBALS['plugin']->getTable('navigation_details') . " SET active = 0 WHERE lang = '" . $GLOBALS['plugin']->getActiveLang() . "' AND node_id = " . $GLOBALS['plugin']->getValue('tpl_id'),__FILE__,__LINE__);
