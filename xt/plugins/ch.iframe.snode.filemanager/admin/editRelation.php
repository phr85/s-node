...
$GLOBALS['plugin']->contribute('edit_relation_buttons','Save', 'saveRelation','','0');
$GLOBALS['plugin']->contribute('edit_relation_buttons','Save and close', 'saveRelationAndClose','','0');
...
$result = XT::query("
    ...
    WHERE
        ...
        AND content_type = " . $GLOBALS['plugin']->getContentType("File") . "
