<?php
$result = XT::query("SELECT (max(position) +1) as position FROM " . XT::getTable('relations') . " WHERE content_type=" . XT::getContentType('Filefolder') . " AND content_id=" . XT::getValue('node_id'),__FILE__,__LINE__);
