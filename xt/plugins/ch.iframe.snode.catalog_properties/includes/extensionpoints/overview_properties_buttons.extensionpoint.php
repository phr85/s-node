<?php
function xt_ch_iframe_snode_catalog_properties_contribute_overview_properties_buttons(){
    $args = func_get_args();
    $args = $args[0];
 ...
 */
function xt_ch_iframe_snode_catalog_properties_build_overview_properties_buttons(){
