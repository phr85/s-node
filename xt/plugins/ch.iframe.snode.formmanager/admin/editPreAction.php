...
if($GLOBALS['plugin']->getValue("preaction_id") != ''){
    $GLOBALS['plugin']->setSessionValue("preaction_id", $GLOBALS['plugin']->getValue("preaction_id"));
}
...
$content = XT::build("editPreAction.tpl");
