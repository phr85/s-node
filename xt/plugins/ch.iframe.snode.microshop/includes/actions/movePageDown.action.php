...
XT::query("UPDATE " . XT::getTable('microshop_pages') . " set position=position-1 WHERE display_id = " . XT::autoval("display_id","S") . " and position > " . $move[0]['position'] . " order by position asc Limit 1");
