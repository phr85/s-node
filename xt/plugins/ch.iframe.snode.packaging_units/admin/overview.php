...
if(XT::getPermission("list")){
    ...
    XT::enableAdminNavigator('packaging_units', 'id' );
    ...
    $result = XT::query("
        SELECT
            ...
            ud.full
        FROM
            " . $GLOBALS['plugin']->getTable('packaging_units') . " as u
        LEFT JOIN
            " . $GLOBALS['plugin']->getTable('packaging_units_det') . " as ud ON (u.id = ud.id AND ud.lang='" . $GLOBALS['plugin']->getActiveLang() . "')
