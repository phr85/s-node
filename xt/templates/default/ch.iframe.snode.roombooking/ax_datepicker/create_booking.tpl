<a href="javascript:document.getElementById('year').value='{$YEAR-1}';updateMeDate();">&lt;</a>
<select name="x{$BASEID}_year" id="year" onchange="updateMeDate();">
...
<a href="javascript:document.getElementById('month').value='{$MONTH-1}';updateMeDate();">&lt;</a>
<select name="x{$BASEID}_month" id="month" onchange="updateMeDate();">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        class="date_box{if $BOOKEDDAYS[$day] > 0}_marked{/if}" onclick="document.getElementById('day').value='{$day}'; updateMeDate();">
        {if $day == ""}&nbsp;{else}
        <a href="#" onclick="document.getElementById('day').value='{$day}'; updateMeDate();">{$day}</a>{/if}
