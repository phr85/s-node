...
<input type="hidden" name="x{$BASEID}_day" size="2" value="{$day}" />
<input type="hidden" name="x{$BASEID}_month" size="2" value="{$month}" />
<input type="hidden" name="x{$BASEID}_year" size="4" value="{$year}" />
    </td>
 </tr>
 <tr>
