...
<table cellspacing="0" cellpadding="0" width="100%">
     <tr>
      ...
      {foreach from=$RECIPE item=ENTRY}
      <tr class="{cycle values="row_a,row_b"}">
       <td class="button">
        {if $ENTRY.lang_active  == 1}{actionIcon
             ...
             action         = "browserRemoveRecipeFromTree"
             icon           = "delete.png"
             form           = "browser_nodes"
             perm           = "browserRecipe"
             title          = "remove recipe association from node"
             ask            = "Are you sure to remove this recipe from this node?"
             recipe_id             = $ENTRY.id
