<form method="POST" name="recipe" onSubmit="window.document.forms['editRecipe'].x{$BASEID}_yoffset.value= window.pageYOffset;">
...
<tr>
  ...
  window.close();"><img src="images/icons/check.png" {"select this recipe"|alttag}></a>
   </td>
   <td class="row">
   {$LASTENTRY.id}
   </td>
