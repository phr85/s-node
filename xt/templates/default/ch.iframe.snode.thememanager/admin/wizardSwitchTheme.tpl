...
<div id="content">
<h1>{"Switch live site to another theme"|translate}</h1>
<p id="introduction">{"Which theme should be activated?"|translate}</p>
<br />
...
<div id="control">
<input type="image" onclick="this.form.x{$BASEID}_action.value='switchTheme';this.form.submit();" name="x{$BASEID}_wizard_submit" src="{$XT_IMAGES}installer/de/weiter.gif" />
</div>
</form>
