...
<table cellpadding="0" cellspacing="0" width="100%">
 <tr>
  <td class="view_header" colspan="2">
   <span class="title_light">{"Expression"|translate}:</span><span class="title"> {$EXP|truncate:25:"..."}</span> ({$PACKAGE_TITLE})
  </td>
 </tr>
 <tr>
...
<table cellpadding="0" cellspacing="0" width="100%">
 <tr class="row_b">
  <td class="row" colspan="2"><textarea name="x{$BASEID}_new_exp"rows="2" cols="50">{$EXP}</textarea></td>
 </tr>
...
<input type="hidden" name="x{$BASEID}_package_id" value=""/>
<input type="hidden" name="x{$BASEID}_package_title" value=""/>
{yoffset}
</form>
