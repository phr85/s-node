...
<div id="content">
<h1>{"Online installation / update"|translate}</h1><br/><br/>
...
<input type="image" onclick="this.form.x{$BASEID}_action.value='remoteinstall';this.form.submit();" name="x{$BASEID}_wizard_submit" src="{$XT_IMAGES}installer/de/weiter.gif" />
</div>
