...
<div id="content">
<h1>{"Upload a theme"|translate}</h1>
<p id="introduction">{"Upload a theme from local source"|translate}</p>
<br />
...
<input type="image" onclick="this.form.x{$BASEID}_action.value='uploadTheme';this.form.submit();" name="x{$BASEID}_wizard_submit" src="{$XT_IMAGES}installer/de/weiter.gif" />
</div>
</form>
