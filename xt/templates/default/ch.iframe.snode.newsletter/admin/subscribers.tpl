...
<tr> 
 <td class="row">Filtere nach email:</td>
  <td class="row" align="right">
   <input type="text" name="x{$BASEID}_addrfilter" value="{$ADDRFILTER}" />
...
<table cellspacing="0" cellpadding="0" width="100%">
 <tr>
  ...
  <td class="table_header" width="110">{actionIcon action="NULL" form=overview label="Subscribed at" sort=$sort.0.value icon=$sort.0.icon}</td>
 </tr>
 ...
 <tr class="{cycle values=row_a,row_b}">
  ...
  actionIcon
      ...
      ask="Are you sure you want to delete this subscriber?"
      subscriber_id=$SUBSCRIBER.id
  }</td>
