<form action="{$smarty.server.PHP_SELF}?TPL={$TPL}" method="POST" name="edit_category">
 {include file="includes/buttons.tpl" data=$EDIT_CATEGORY_BUTTONS withouthidden=true}
 {include file="includes/lang_selector_submit.tpl" form="edit_category"}
 <table cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
   ...
   <td class="right">
    <a href="#" onclick="popup('{$smarty.server.PHP_SELF}?TPL=597&x240_field=x{$BASEID}_image&x240_form=edit_category',770,470,'picker');"><img style="cursor: hand; cursor: pointer;" src="{$XT_IMAGES}icons/pick_photo.png" title="{"Pick an image"|translate}" alt="{"Pick an image"|translate}" /></a>{
    actionIcon
