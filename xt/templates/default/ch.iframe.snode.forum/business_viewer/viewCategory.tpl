...
<tr>
 <td colspan="2" class="header"><b>Kategorie "{$PARENT_CATEGORY.title}"</b><br />{"The following categories are in this area"|translate}:</td>
</tr>
<tr>
...
{subplugin package="ch.iframe.snode.forum" module="newest_entries"}