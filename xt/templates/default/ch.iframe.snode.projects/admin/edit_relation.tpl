...
<table cellspacing="0" cellpadding="0" width="100%">
 ...
 <tr>
  ...
  <td class="right">
   <select name="x{$BASEID}_target_content_id" onChange="document.forms[0].x{$BASEID}_action.value='saveRelation';document.forms[0].submit();">
    <option value="0">-- {"Please choose"|translate} --</option>
...
<input type="hidden" name="x{$BASEID}_project_id" value="{$RELATION.content_id}" />
