...
<td class="lang_tab">{"Rolemode"|translate}</td>
</table>
<table cellspacing="0" cellpadding="0" width="100%">
...
<tr class="{cycle values="row_a,row_b"}">
<td class="row" style="padding-left: 5px; width: 1px;padding-right: 0px;"><img src="{$XT_IMAGES}icons/role.png" width="16" /></td>
      <td class="row">{if $ITEM.id == $ROLE_ID}{actionLink
      action= "clickOnRole"
      form="master"
      yoffset=1
      text=$ITEM.title
