...
{include file="includes/lang_selector_simple.tpl" form="searchadmin"} 
 <table cellspacing="0" cellpadding="0" width="100%">
  <tr>
   <td class="table_header" width="50">ss{"Options"|translate}</td>
   <td class="table_header" width="32">ID</td>
   <td class="table_header" width="200">{"Keyword"|translate}</td>
   <td class="table_header" width="100">{"user"|translate}</td>
   <td class="table_header">{"search date"|translate}</td>
  </tr>
