...
<td class="sender">{$MSG.receiver|xt_getUserProperties:"username"}</td>
<td class="subjectandtext"><span><a href="{$smarty.server.PHP_SELF}?TPL={$TPL}&amp;x{$BASEID}_mode=read&amp;x{$BASEID}_message_id={$MSG.id}">{$MSG.subject}</a></span><br />
{$MSG.text}...</td>
