<form method="post" id="tree" name="tree" action="{$smarty.server.PHP_SELF}?TPL={$TPL}" onSubmit="window.document.forms['o'].x{$BASEID}_yoffset.value=window.pageYOffset;">
