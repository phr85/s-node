<form method="post" name="view" action="{$smarty.server.PHP_SELF}?TPL={$TPL}">
<table cellspacing="0" cellpadding="0" width="100%">
 <tr>
  ...
  <td class="view_header" align="right"><a href="{$XT_WEB_ROOT}download.php?file_id={$FILE.id}"><img src="{$XT_IMAGES}icons/download.png" alt="" class="icon" /></a></td>
 </tr>
</table>
<table cellspacing="0" cellpadding="0" width="100%">
 <tr>
 ...
 <tr>
  <td class="view_header" colspan="4">
   <span><embed width="100%" src="{$XT_WEB_ROOT}download.php?file_id={$FILE.id}&amp;date={$FILE.mod_date}" alt="" /></span>
  </td>
 </tr>
 <tr>
  <td class="view_separator" colspan="4"><img src="{$XT_IMAGES}spacer.gif" alt="" /></td>
 ...
 <tr>
  <td class="view_header" colspan="4">
   <span><img src="{$XT_WEB_ROOT}download.php?file_id={$FILE.id}&file_name={$FILE.title}&file_version=1&amp;date={$FILE.upload_date}" alt="" style="border: 1px solid black;"/></span>
  </td>
 </tr>
 <tr>
  <td class="view_separator" colspan="4"><img src="{$XT_IMAGES}spacer.gif" alt="" /></td>
