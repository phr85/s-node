...
{/if}">
      ...
      <td class="button" width="80" align="right"><a href="javascript:window.parent.opener.document.forms['{$FORM}'].{$FIELD}.value={$ARTICLE.id};window.parent.opener.document.forms['{$FORM}'].{$FIELD}_title.value='{$ARTICLE.title}';
