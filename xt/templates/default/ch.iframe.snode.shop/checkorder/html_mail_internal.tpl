...
<tr>
  ...
  <td class="basket_borderbottom" align="left" valign="top">{$ITEM.title} ({$ITEM.art_nr})</td>
...
F&uuml;r weitere Fragen stehen wir Ihnen gerne via Email:
<br /><br />
