{if $smarty.get.adminmode ==1}
    {include file="includes/header/header_admin.tpl"}
     <table cellspacing="0" cellpadding="0" width="100%" style="height: 100%;">
      <tr>
       <td style="background-color: #FFFFFF; border: 1px solid #002E95;" valign="top" width="{if $lwidth > 1}{$lwidth}{else}33{/if}%">
       ...
       <td>
        {iframe_paper url="?TPL=%TPL%&amp;tabs=0&amp;module=%MODULE%" name="slave2" template=$s2_template s1_tab=$s2_tab}
       </td>
      </tr>
     </table>
