...
function saveDate(day) {
    window.opener.document.forms[0].{/literal}{$FIELD}{literal}date_str.value = document.getElementById('use_date_str').value;
    window.opener.document.forms[0].{/literal}{$FIELD}{literal}date.value=document.getElementById('use_date').value;
